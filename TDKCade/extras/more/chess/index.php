...
<html>
<head>
	<title> p4wn: javascript chess </title>
	<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
	<link rel="stylesheet" href="chess_6k.css" type="text/css" />
	<script src="aab_chess_6k.js" type="text/javascript"></script>
</head>
<body onload="H()">
		...
		<tr>
			<td colspan="2" class="controlBar controlBarUpper">
				...
				<td class="buttonBarUpper">
					<button onclick="window.location.href='index.php'">&nbsp;new game&nbsp;</button>
	...
	<tr>
		<td align="left" id="aboutCell">
			<p>
				<strong>P4wn</strong> is Javascript chess written by Douglas Bagnall. Original website can be found here: <a href="http://p4wn.sourceforge.net/">http://p4wn.sourceforge.net/</a>.
			</p>
			<p>
